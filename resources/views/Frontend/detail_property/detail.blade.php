          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="slider__image__detail-large-two owl-carousel owl-theme">
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/01.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="images/profile-blog-1.jpg" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/bg19.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="images/profile-blog-1.jpg" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/2.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                                  <span class="badge badge-primary text-capitalize mb-2">house</span>
                                  <div class="price">
                                      <h5 class="text-capitalize">$13,000/mo</h5>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/gallery2-1.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/gallery3-1.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/gallery4-1.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/gallery5-1.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                      ...
                      <div class="item">
                          <div class="slider__image__detail-large-one">
                              <img src="{{asset('assets/images/gallery1.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                              <div class="description">
                                  <figure>
                                      <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid">
                                  </figure>
                  ...
                  <div class="slider__image__detail-thumb-two owl-carousel owl-theme">
                      ...
                      <div class="item">
                          <div class="slider__image__detail-thumb-one">
                              <img src="{{asset('assets/images/gallery.jpg')}}" alt="" class="img-fluid w-100 img-transition">
                          </div>
                      </div>
                      <div class="item">
                          <div class="slider__image__detail-thumb-one">
                          ...
                          <div class="single__detail-features">
                              ...
                              <div class="tab-content" id="pills-tabContent">
                                  <div class="tab-pane fade show active" id="pills-map-location" role="tabpanel" aria-labelledby="pills-map-location-tab">
                                      <div id="map-canvas">
                                          <iframe class="h600 w100" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d50446.89789906054!2d-122.41577600000001!3d37.791654!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd473843de08ff793!2sBetter%20Property%20Management!5e0!3m2!1sen!2sus!4v1591226304089!5m2!1sen!2sus" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                      </div>

                                  </div>
                                  <div class="tab-pane fade" id="pills-street-view" role="tabpanel" aria-labelledby="pills-street-view-tab">
                                      <iframe class="h600 w100" src="https://www.google.com/maps/embed?pb=!4v1553797194458!6m8!1m7!1sR4K_5Z2wRHTk9el8KLTh9Q!2m2!1d36.82551718071267!2d-76.34864590837246!3f305.15097!4f0!5f0.7820865974627469" style="border:0;" allowfullscreen=""></iframe>
                                  </div>
                          ...
                          <div class="single__detail-features">
                              ...
                              <div class="single__detail-features-review">
                                  ...
                                  <div class="media mt-4">
                                      <img class="mr-3 img-fluid rounded-circle" src="images/profile-blog-1.jpg" alt="">
                                      <div class="media-body">
                                          ...
                                          <div class="media mt-4">
                                              <a class="pr-3" href="#">
                                                  <img src="images/logo-1.jpg" alt="" class="img-fluid rounded-circle">
                                              </a>
                                              <div class="media-body">
                      ...
                      <div class="similiar__property-carousel owl-carousel owl-theme">
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      ...
                                      <img src="{{asset('assets/images/gallery16-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                  ...
                                  <div class="card__image-footer">
                                      <figure>
                                          <img src="{{asset('assets/images/profile-blog-1.jpg')}}" alt="" class="img-fluid rounded-circle">
                                      </figure>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery17-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery18-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery9-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery10-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery14-1.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery15-1.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
                          ...
                          <div class="item">
                              ...
                              <div class="card__image">
                                  <div class="card__image-header h-250">
                                      <div class="ribbon text-capitalize">featured</div>
                                      <img src="{{asset('assets/images/gallery11-2.jpg')}}" alt="" class="img-fluid w100 img-transition">
                                      <div class="info"> for sale</div>
                                  </div>
                                  <div class="card__image-body">
                                      <span class="badge badge-primary text-capitalize mb-2">house</span>
